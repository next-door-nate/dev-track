...
// Define mix meta info

function custom_mix_meta_box_markup($object)
{
  wp_nonce_field(basename(__FILE__), "meta-box-nonce");

    ?>
        <div>
            <label for="meta-box-text">Soundcloud Link:</label>
...
function add_mix_meta_box()
{
    add_meta_box("mix-meta-box", "Mix Info", "custom_mix_meta_box_markup", "mixes", "normal", "high", null);
}

add_action("add_meta_boxes", "add_mix_meta_box");


// Save mix meta info

function save_mix_meta_box($post_id, $post, $update)
{
...
add_action("save_post", "save_mix_meta_box", 10, 2);
